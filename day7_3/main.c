    ...
    do
    {
        ...
        case 13:
            ...
            case 1:
                system("cls");
                printf("display\n");
                display(emparr,emparr_size);
                getch();
                break;
            case 2:
                system("cls");

                displayall(emparr,emparr_size);
                getch();
            ...
            case 3:
                ...
                update(emparr,emparr_size);
                getch();

                break;
            case 4:
                system("cls");
                   delete_emp(emparr,emparr_size);
                getch();
...
void update(struct emp *emp_ptr,int size)
{
